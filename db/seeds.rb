...
drake = Fridge.create(location: "dorm", brand: "Sears", size: 10, has_food: false, has_drink: true)
...
drake.food = [
    Food.create(fridge_id: drake.id, name: "cheese", weight: 10, is_vegan: false)
]